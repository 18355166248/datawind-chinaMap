...
const EPSILON = 0.01, // 极小值常量
  RAD_PER_DEG = Math.PI / 180, // 角度转弧度系数
  DEG_PER_RAD = 180 / Math.PI, // 弧度转角度系数
  EARTH_RADIUS = 63781.37, // 地球半径常量
  BASE_RESOLUTION = 1565.4303392804097, // 基础分辨率
  EARTH_PERIMETER = EARTH_RADIUS * Math.PI * 2, // 地球周长
  CACHE_ARRAY = []; // 缓存数组
